...
class FCDiscriminator1(nn.Module):
    ...
    def __init__(self, num_classes, ndf=64):
        ...
        self.conv3 = nn.Conv2d(ndf * 2, ndf * 4, kernel_size=4, stride=2, padding=1)
        self.conv4 = nn.Conv2d(ndf * 4, ndf * 8, kernel_size=4, stride=2, padding=1)
        self.classifier = nn.Conv2d(ndf * 8, 1, kernel_size=4, stride=2, padding=2)
...
class FCDiscriminator2(nn.Module):
    ...
    def __init__(self, num_classes, ndf=64):
        ...
        self.conv2 = nn.Conv2d(ndf, ndf * 2, kernel_size=4, stride=2, padding=1)
        self.conv3 = nn.Conv2d(ndf * 2, ndf * 4, kernel_size=4, stride=2, padding=1)
        self.conv4 = nn.Conv2d(ndf * 4, ndf * 8, kernel_size=4, stride=2, padding=2)
        self.classifier = nn.Conv2d(ndf * 8, 1, kernel_size=4, stride=2, padding=2)
...
class FCDiscriminator3(nn.Module):
    ...
    def __init__(self, num_classes, ndf=64):
        ...
        self.conv1 = nn.Conv2d(num_classes, ndf, kernel_size=4, stride=2, padding=1)
        self.conv2 = nn.Conv2d(ndf, ndf * 2, kernel_size=4, stride=2, padding=1)
        self.conv3 = nn.Conv2d(ndf * 2, ndf * 4, kernel_size=4, stride=2, padding=2)
        self.conv4 = nn.Conv2d(ndf * 4, ndf * 8, kernel_size=4, stride=2, padding=2)
        self.classifier = nn.Conv2d(ndf * 8, 1, kernel_size=4, stride=2, padding=2)
